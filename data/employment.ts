...
export const EMPLOYMENT = [
  ...
  },
  {
    id: 'spreeCommerce',
    featured: true,
    date: 'Dec 2011 - Jul 2015',
    position: 'Senior Frontend Developer / Product Designer',
    company: 'Spree Commerce Inc.',
    location: 'Lviv / Bethesda, MD',
  ...
  {
    id: 'lifeEnsured',
    date: 'Dec 2010 - Sep 2011',
    position: 'Web Designer / Frontend Developer',
    company: 'Lifeensured Inc.',
    location: 'Lviv / New York City',
    employment: 'Remote, Freelance',
    description:
  ...
  {
    id: 'eney',
    date: 'Mar 2006 - Oct 2007',
    position: 'Technical / Print Designer',
    company: 'Eney',
    location: 'Lviv',
    employment: 'Full-time',
    description:
