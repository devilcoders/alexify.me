...
const SocialLink: React.FC<Props> = ({ url, icon, title }) => (
  <a
    className="group relative z-10 hover:z-50 fill-current text-gray-5 dark:text-gray-7 ease-in-out duration-300 transition-colors hover:text-gray-9 dark:hover:text-gray-0"
    title={title}
    href={url}
